...
const HistoryPage = () => {
  return (
    <section className="mx-auto max-w-7xl space-y-4">
      ...
      <article className="rounded-2xl border border-border-color bg-main p-5 shadow-xs md:p-7">
        <h1 className="text-[34px] font-semibold text-title">Full History</h1>

        <div className="mt-8 grid gap-4 border-b border-[#EAECF0] pb-8 sm:grid-cols-2 lg:grid-cols-3">
          <div>
            <p className="flex items-center gap-1.5 text-xs text-description">
              <User className="size-3.5" />
              Patient Name
            </p>
            <p className="mt-1 text-[30px] font-semibold text-title">Emma Davis</p>
          </div>

          <div>
            <p className="text-xs text-description">Age</p>
            <p className="mt-1 text-[30px] font-semibold text-title">34 years old</p>
          </div>

          <div>
            <p className="text-xs text-description">Patient ID</p>
            <p className="mt-1 text-[30px] font-semibold text-title">MED-2024-0892</p>
          </div>
        ...
        <div className="mt-8">
          <h2 className="text-2xl font-semibold text-title">Past Reports History</h2>
